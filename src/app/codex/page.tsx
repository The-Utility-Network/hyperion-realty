...
const terms = [
    ...
    { term: 'Trading Volume Fee', category: 'TOKENOMICS', def: 'A 1.5% protocol-level fee applied to every secondary market trade of ERC20 property tokens. Revenue is routed directly to Hyperion to fund platform maintenance, secure oracle node feeds, and operational sustainment.' },
    ...
    { term: 'Supply Curve', category: 'TOKENOMICS', def: 'The total ERC20 token supply for each property, fixed immutably at mint time. Calibrated at a 120% ratio (incorporating a 20% tokenization markup) relative to the physical property\'s appraised valuation. Cannot be modified without DAO governance approval.' },
    ...
    { term: 'Tokenization Markup', category: 'TOKENOMICS', def: 'A 20% premium applied to the appraised value of a physical property at the time of tokenization. The markup is mathematically distributed to seed the algorithmic AMM liquidity pool (10%), distribute corporate profits (5%), and fund the protocol launch reserves (5%).' },
    { term: 'Algorithmic AMM Liquidity Seed', category: 'TOKENOMICS', def: 'The 10% token supply allocation from the property tokenization markup that is immediately locked into an Automated Market Maker (AMM) pool to ensure instant, reliable, and decentralized secondary market liquidity for all token holders.' },
    { term: 'Asset Management Fee', category: 'TOKENOMICS', def: 'A 1.0% annual management fee deducted by Hyperion from gross property earnings (estimated up to 6-7% Net Operating Income), resulting in a net yield distribution of approximately 5-6% to token holders.' },
];
